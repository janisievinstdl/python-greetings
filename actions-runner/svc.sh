...
SVC_NAME="actions.runner.janisievinstdl-python-greetings.Janiss-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (janisievinstdl-python-greetings.Janiss-MacBook-Pro)"
